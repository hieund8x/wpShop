			...
			<div class="row">
				<div class="col-sm-8">
					...
					<div class="results-text">
						<h3>
							<?php echo sprintf(_n('Showing <span>%d</span> result for', 'Showing <span>%d</span> results for:', $found_posts, TD), $found_posts); ?>
							<span class="search-text">&quot;<?php echo esc_html(get('s')); ?>&quot;</span>
						</h3>
						
						<p>
							<?php _e("Didn't find what you were looking for?", TD); ?>
							<a href="#" id="search-again"><?php _e("Search again", TD); ?></a>
						</p>
					</div>
				...
				<div class="col-sm-4">
					...
					<form action="<?php echo home_url(); ?>" method="get" class="search search-box" enctype="application/x-www-form-urlencoded">
						...
						<input type="text" class="search_input" name="s" alt="" placeholder="<?php _e('Search...', TD); ?>" value="" /> 
				...
				<article class="search-entry">
					...
					<a href="<?php the_permalink(); ?>" class="thumb">
						...
						if(has_post_thumbnail() && file_exists(ABSPATH . $image_link)):
							...
							echo laborator_show_img(get_the_id(), 'shop-thumb-2');
