...
$post_slider_images = gb_field('post_slider_images');
	...
	<div class="post_details">
		...
		<h2>
			<?php if($show_category && has_category()): ?>
				<?php _e('In ', TD); the_category(', '); ?>,
			<?php endif; ?>
			
			<?php if($post_date): ?>
			<strong><?php echo sprintf(__('on %s', TD), get_the_time("F d, Y - H:i")); ?></strong><?php echo has_tag() ? ',' : ''; ?>
			<?php endif; ?>
		...
		<div class="post-content">
			...
			<?php wp_link_pages(array(
					'before' => '<div class="post-pagination">' . __( 'Pages:', TD), 
					'after' => '</div>',
					'pagelink' => '<span>%</span>'
				)); 
				?>
...
<div class="share-post">
	<h1><?php _e('Share This Story', TD); ?>:</h1>
