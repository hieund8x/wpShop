...
<div class="map-type-switcher<?php echo $map_type_id == 1 || $map_type_id == 2 ? ' satellite-view' : ''; ?>">
	...
	<a href="#" data-tooltip="<?php _e('Roadmap', TD); ?>" data-type="roadmap" class="type-roadmap simptip-position-top simptip-fade<?php echo $map_type_id == 0 ? ' current' : ''; ?>"></a>
	<?php endif; ?>
	
	<?php if(in_array('satellite', $allowed_map_types)): ?>
	<a href="#" data-tooltip="<?php _e('Satellite', TD); ?>" data-type="<?php echo $map_type_id == 2 ? 'hybrid' : 'satellite'; ?>" class="type-satellite simptip-position-top simptip-fade<?php echo $map_type_id == 2 ? ' type-hybrid' : ''; echo $map_type_id == 1 || $map_type_id == 2 ? ' current' : ''; ?>"></a>
	<?php endif; ?>
	
	<?php if(in_array('street', $allowed_map_types)): ?>
	<a href="#" data-tooltip="<?php _e('Street View', TD); ?>" data-type="street" class="type-street simptip-position-top simptip-fade<?php echo $map_type_id == 3 ? ' current' : ''; ?>"></a>
	<?php endif; ?>
</div>
<?php endif; ?>
