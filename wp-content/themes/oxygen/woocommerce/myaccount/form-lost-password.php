...
<div class="col-md-6">
    <div class="white-block block-pad">
		...
		<form method="post" class="lost_reset_password">
		    ...
		    <p class="form-row">
		    	<input type="submit" class="button btn-default btn full-width-btn up" name="wc_reset_password" value="<?php echo 'lost_password' == $args['form'] ? __( 'Reset Password', 'woocommerce' ) : __( 'Save', 'woocommerce' ); ?>" />
		    </p>
	...
	<a href="<?php echo MYACCOUNTURL; ?>" class="woo-back-link"><?php _e('&laquo; Back to login page', 'woocommerce'); ?></a>
</div>
