...
global $product, $woocommerce_loop, $quickview_enabled, $row_clear, $is_products_carousel;
	...
	<?php do_action( 'woocommerce_before_shop_loop_item' ); ?>
		...
		<div class="image<?php echo $item_preview_type == 'Second Image on Hover' && count($product_images_urls) ? ' hover-second-only' : ' full-gallery'; ?>">
			...
			<a href="<?php the_permalink(); ?>" class="thumb">
				...
				$thumb_size = 'shop-thumb-1' . (isset($row_clear) && $row_clear < 3 ? '-large' : '');
				...
				else
				{
					...
					{
						echo laborator_show_img(array_shift($product_images_urls), $thumb_size);
					}
					else
					{
