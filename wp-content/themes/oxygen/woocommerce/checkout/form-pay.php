			...
			<ul class="cart-totals">
				...
				if ( sizeof( $order->get_items() ) > 0 ) :
					foreach ( $order->get_items() as $cart_item_key => $item ) :
						...
						# start: modified by Arlind Nushi
						$quantity = apply_filters( 'woocommerce_checkout_cart_item_quantity', ' <strong class="product-quantity">' . sprintf( __('Quantity: ', TD) . ' %s', $item['qty'] ) . '</strong>', $item, $cart_item_key );
						# end: modified by Arlind Nushi
						echo '
							<li>
