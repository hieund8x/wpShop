...
$bg_images = array(
	'http://oxygen.dev/wp-content/uploads/2013/06/Poster_1_flat-300x300.jpg',
	'http://oxygen.dev/wp-content/uploads/2013/06/Poster_2_flat-300x300.jpg',
	'http://oxygen.dev/wp-content/uploads/2013/06/Poster_5_flat-300x300.jpg'
);
...
$of_options[] = array( 	"name" 		=> "Columns Count",
						...
						"type" 		=> "select",
						"options" 	=> array("[1/2] Two Columns", "[1/3] Three Columns", "[1/4] Four Columns", "[1/6] Two Columns"),
						"fold"		=> "footer_widgets"
				);
...
$of_options[] = array( 	"desc" 		=> "Item thumnail preview type.",
...
$of_options[] = array( 	"name" 		=> "Pagination",
						...
						"std" 		=> "4 rows",
						"type" 		=> "select",
						"options" 	=> array("6 rows", "5 rows", "4 rows", "3 rows", "2 rows", "1 row")
				);
...
$of_options[] = array( 	"name"		=> "Search results",
						...
						"std" 		=> array('post' => 1, 'page' => 1, 'product' => 1),
						"type" 		=> "multicheck",
						"options" 	=> $post_types
				);
				
$of_options[] = array( 	"name"		=> "Thumbnails Generator",
						"desc" 		=> "Image quality for JPEG thumbnails (higher value = better quality).<br /><br /><em>Note: If you change thumbnails quality, current thumbnails will still be at the same quality. <br />The changes will take effect only if you delete all generated thumbnails by <a href='".admin_url()."?lab_img_clear_cache=1' target='_blank' onclick='return confirm(\"Are you sure?\");'>clicking here</a>, they will be created automatically.</em>",
