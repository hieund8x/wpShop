...
$form_args = array(
	'title_reply' 			=> '<h1 class="title">' . __('Leave a Comment', TD) . '</h1>',
	...
	<div class="row">
		<div class="col-lg-12 mobile-padding">
			<label for="comment">' . __('Message', TD) . ' <span class="red">*</span></label>
			<textarea id="comment" name="comment" class="autogrow" placeholder="' . __('Message:', TD) . '" rows="3" aria-required="true"></textarea>
		</div>	
	</div>'
);
